...
import { setEntertainmentDetailAction } from "../actions/HomeActionCreators";

function setDetails(payload){
  store.dispatch(setEntertainmentDetailAction(payload))
}


export function EntertainmentCardComponent(props){
    ...
    return (
        <Content>
          <Card>
            ...
            <CardItem button onPress={()=>{setDetails(article); nav.navigate('entertainment-detail')}}>
              <Left>               
                <Body>
