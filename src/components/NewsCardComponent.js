...
import { setNewsDetailAction } from "../actions/HomeActionCreators";

function setDetails(payload){
  store.dispatch(setNewsDetailAction(payload))
}


export function NewsCardComponent(props){
    ...
    return (
        <Content>
          <Card>
            ...
            <CardItem button onPress={()=>{setDetails(article); nav.navigate('news-detail')}}>
              <Left>               
                <Body>
